...
function List() {
    ...
    return (
        <Helmet title="Danh sách khách hàng">
            <Toaster
                toastOptions={{
                    className: '',
                    style: {
            ...
            <div className="ranking">
                ...
                <div className="ranking_container">
                                    ...
                                    displayList.map((item, index) => (
                                        <tr value={item.id} key={index} onClick={handCheck}>
                                            ...
                                            <td style={{ textAlign: 'end' }}>
                                                {item.totalPrice === 0 ? '0' : item.totalPrice?.toFixed(3)}
                                            </td>
                                            <td>{item.purchased ? 'Đã thanh toán' : 'Chưa thanh toán'}</td>
                                            <td>{item.active ? 'hoạt động' : 'ngưng hoạt động'}</td>
                                            {/* <td>
                    ...
                    {/* <div className="send_mail">
                        <button disabled={targetUsers.length ? false : true} className="send_btn" onClick={handWarning}>
                            {' '}
                            Nhắc nhở
                        </button>
                    </div> */}
